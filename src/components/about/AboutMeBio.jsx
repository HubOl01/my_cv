...
const about = [
  "Я программист с опытом разработки более 4 лет. Начинал с С++ и консольных приложений, затем перешёл к веб-разработке на HTML/CSS. Понял, что хочу развиваться дальше, и изучил C# и Xamarin (сейчас MAUI), чтобы заняться мобильной разработкой.",
